...
enter_parameters_by_functions = [
    ("1", []),
    ("Утром", [{'poster_name': 'larry', 'poster_avatar': 'https://randus.org/avatars/m/81898dbdbdffdb18.png',
                'pic': 'https://images.unsplash.com/photo-1581235854265-41981cb85c88?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8'
                       'MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80',
               ...
               {'poster_name': 'larry', 'poster_avatar': 'https://randus.org/avatars/m/81898dbdbdffdb18.png',
                'pic': 'https://images.unsplash.com/photo-1494952200529-3ceb822a75e2?ixid=MnwxMjA3fDB8MHxwaG90by1wYW'
                       'dlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=880&q=80',
    ...
    ("тарелка", [{'poster_name': 'leo', 'poster_avatar': 'https://randus.org/avatars/w/c1819dbdffffff18.png',
                  'pic': 'https://images.unsplash.com/photo-1525351326368-efbb5cb6814d?ixid=MnwxMjA3fDB8MHxwaG90by1w'
                         'YWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=580&q=80',
                  'content': 'Ага, опять еда! Квадратная тарелка в квадратном кадре. А на тарелке, наверное, пирог! '
                             ...
                             ' это, то, значит, они все подумают, что я плохая девочка... Но потом мне вспомнилось,'
                             ' как они на меня смотрели. Когда я была маленькой, на кухне всегда были родители,'
                             ' бабушка, дедушка, дядя Борис... Все вместе. И всегда одна я, потому что все остальные'
                             ' приходили туда лишь изредка. Мне казалось, если бы все ходили на работу, как и я, в'
                             ' этот свой офис, было бы совсем неинтересно.',
                  'views_count': 376, 'likes_count': 154, 'pk': 1}])
]


@pytest.mark.parametrize('subtext, output', enter_parameters_by_functions)
def test_search_for_posts(subtext, output):
    assert search_for_posts(subtext) == output, f"Ошибка для {subtext}"
